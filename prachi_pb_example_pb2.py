...
# source: prachi_pb-example.proto
...
Request = _reflection.GeneratedProtocolMessageType('Request', (_message.Message,), dict(
  DESCRIPTOR = _REQUEST,
  __module__ = 'prachi_pb_example_pb2'
